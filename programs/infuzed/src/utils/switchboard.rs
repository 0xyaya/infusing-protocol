...
//     feed.check_staleness(Clock::get().unwrap().unix_timestamp, i64::MAX)?;
...
//     // let nct_usd_price_bis = get_price_from_feed(nct_usd_price_feed, max_staleness)?;

//     msg!("sol_usd_price: {}", nct_usd_price);
//     msg!("nct_usd_price: {}", nct_usd_price);

//     Ok(nct_usd_price / nct_usd_price)
// }
